...
in    λ(settings : Settings.Type)
    → λ(configmap : Kubernetes.ConfigMap.Type)
    → λ(secret : Kubernetes.Secret.Type)
            ...
            , containers =
              [ Kubernetes.Container::{
                              ...
                              → [ Kubernetes.EnvVar::{
                                  ...
                                  , valueFrom = Some Kubernetes.EnvVarSource::{
                                    , secretKeyRef = Some Kubernetes.SecretKeySelector::{
                                      , name = Some secret.metadata.name
                ...
                , ports = Some
                  ...
                  , Kubernetes.ContainerPort::{
                    , containerPort = settings.ports.cluster-coordination.number
                    , protocol = Some "TCP"
                    }
                  ]
